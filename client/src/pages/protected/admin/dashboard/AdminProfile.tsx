...
import AdminCloseAccountModal from "./AdminCloseAccountModal";
import AdminGovernmentIdSection from "./AdminGovernmentIdSection";
import {
  getMyAdminProfile,
        ...
        <>
          ...
          <div className="space-y-5">
            <section className="rounded-2xl border border-rose-light bg-white p-5 md:p-6">
              ...
              <AdminGovernmentIdSection isEditing={isEditing} />
            </section>
          </div>
